...
<div class="h-full flex flex-col items-center justify-center p-8 animate-fadeIn">
  <div class="w-full max-w-sm text-center">
    ...
    <div class="flex gap-3 mb-6">
      <button on:click={openGitHub} class="flex-1 flex items-center justify-center gap-2 px-5 py-3 text-sm font-medium rounded-xl bg-gradient-to-r from-indigo-500 to-purple-600 text-white shadow-lg shadow-indigo-500/25 hover:shadow-xl hover:-translate-y-0.5 transition-all">
      ...
      <button on:click={openDataDir} class="flex-1 flex items-center justify-center gap-2 px-5 py-3 text-sm font-medium rounded-xl bg-white dark:bg-slate-800 ring-1 ring-slate-200 dark:ring-slate-700 text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700 hover:-translate-y-0.5 transition-all">
    ...
    <div class="flex flex-wrap justify-center gap-2 mb-8">
      <span class="px-2.5 py-1 rounded-lg bg-orange-50 dark:bg-orange-900/20 text-orange-600 dark:text-orange-400 text-xs ring-1 ring-orange-200/50 dark:ring-orange-800/30">Tauri 2</span>
      <span class="px-2.5 py-1 rounded-lg bg-orange-50 dark:bg-orange-900/20 text-orange-600 dark:text-orange-400 text-xs ring-1 ring-orange-200/50 dark:ring-orange-800/30">Svelte</span>
      <span class="px-2.5 py-1 rounded-lg bg-orange-50 dark:bg-orange-900/20 text-orange-600 dark:text-orange-400 text-xs ring-1 ring-orange-200/50 dark:ring-orange-800/30">Rust</span>
      <span class="px-2.5 py-1 rounded-lg bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 text-xs ring-1 ring-blue-200/50 dark:ring-blue-800/30">SQLite</span>
    </div>
  </div>
